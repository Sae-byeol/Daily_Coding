...
//            this.button=itemView.findViewById(R.id.news_item_button);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (pos != RecyclerView.NO_POSITION){
                        Intent intent=new Intent(context, ChanelNewActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        ...
                        intent.putExtra("image",mDataset.get(pos).getImageUrl().split(",")[1]);
    ...
    public void onBindViewHolder(@NonNull ChanelAdapter.ViewHolder holder, int position) {
        ...
        Glide.with(context)
                .load(mDataset.get(position).getImageUrl().split(",")[0])
